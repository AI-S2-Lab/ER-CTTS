...
def evaluate(device, model, step, configs, logger=None, vocoder=None, losses=None):
    ...
    dataset = Dataset(
        "val_synthesize_{}.txt".format(level_tag), preprocess_config, model_config, train_config, sort=False, drop_last=True
    )
    ...
    message = "Validation Step {}, Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Pitch Loss: {:.4f}, Energy Loss: {:.4f}, Duration Loss: {:.4f}, CTC Loss: {:.4f}, Binarization Loss: {:.4f}, BCE Loss: {:.4f}".format(
